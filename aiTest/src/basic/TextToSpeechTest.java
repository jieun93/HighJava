...
/*
 *  IBM Text To Speech 서비스는 IBM의 음성합성기능을 사용하여  다양한 언어, 방언 및 음성으로  텍스트를 자연스러운 발음으로 합성하는 API를 제공한다.
 *  
	...
	public void executeService() {
		try {
			...
			SynthesizeOptions synOptions = new SynthesizeOptions.Builder()
					...
					// 실행할 Text 문장
					.text("ciao sono Francesca venetuti ")
					
					.accept("audio/wav")	// 저장할  audio파일 종류 설정
					.voice("it-IT_FrancescaV2Voice")	//Voice 설정(영문)
					.build();
