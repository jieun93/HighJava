...
public class MymemberController {
    ...
    void btcShcedual(ActionEvent event) throws IOException {
    	Parent root =  FXMLLoader.load(MymemberController.class.getResource("MySchedual.fxml"));
    ...
    void btnAut(ActionEvent event) throws IOException {
    	Parent root =  FXMLLoader.load(MymemberController.class.getResource("MyAuction.fxml"));
    ...
    void btnInfo(ActionEvent event) throws IOException {
    	FXMLLoader loader = new FXMLLoader(MymemberController.class.getResource("MyInformation.fxml"));
    	Parent root =  loader.load();
    ...
    void btnInters(ActionEvent event) throws IOException {
    	Parent root =  FXMLLoader.load(MymemberController.class.getResource("MymemInterest.fxml"));
    ...
    void btnMinwon(ActionEvent event) throws IOException {
    	Parent root =  FXMLLoader.load(MymemberController.class.getResource("Com_QuestionController.fxml"));
