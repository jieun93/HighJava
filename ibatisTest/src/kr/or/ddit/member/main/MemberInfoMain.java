...
public class MemberInfoMain {
	private static Logger logger = Logger.getLogger(MemberInfoMain.class);
		 ...
		 new MemberInfoMain().memberStart();
		      ...
		      public void memberSearch(){
		  		...
		  		// search   		검색할 내용 
			         ...
			         case 4 : fieldName = "mem_addr";
			        	 break;
			        	 default:
			        		 System.out.println("검색할 데이터를 잘못 선택했습니다.");
			        		 System.out.println("검색작업을 마칩니다.");
			        		 return;
			         }
			         scan.nextLine(); // 버퍼 비우기  nextLine을 사용하기 전에 nextInt ,nextFlot 등이 있으면 버퍼비우기를 해주어야 한다.
			         System.out.println();
		   ...
		   // 회원 정보를 수정하는 메서드2
		      ...
		      public void memberUpdate(){
		         ...
		         if(count==0){
		            System.out.print(memId + "은 없는 회원ID입니다. 수정작업을 종료합니다.");
		            return;
		         }
